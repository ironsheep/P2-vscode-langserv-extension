...
| --- | --- |
|`Insert or F9` (on Windows and Linux) </br>`Fn+Enter or F9` (on Mac) | `spin2.insertMode.rotate`:</br>Rotate thru: Insert -> Overtype -> Align -> and back to Insert...
|`Ctrl+Alt+I` (on Windows) </br>`Cmd+Shift+I` (on Mac)  </br>`Ctrl+Alt+Shift+I` (on RPi/Linux)| `spin2.insertMode.toggle`:</br>Rotate thru: Insert -> Align -> and back to Insert...
